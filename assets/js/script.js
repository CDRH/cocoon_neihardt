...
$(document).ready(function(){
 $('.extended_description').css('display','none');
 $('.body_text').append( " <span class=\"more_container\"><a class=\"show_more\"></a></span" );
 $('.show_more').html('Show More');
 
 $(".show_more").toggle(function() {
	$('.show_more').html('Show Less');
	$('.extended_description').show();
	//$('.extended_description').slideToggle();
	//$('.extended_description').slideDown ();
}, function() {
	$('.show_more').html('Show More');
	$('.extended_description').hide(); 
	//$('.extended_description').slideToggle();
	//$('.extended_description').slideUp();
});
